...
{
    /// <inheritdoc />
    public partial class FilmsAndOthers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenresFilms", x => new { x.GenreId, x.FilmId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheatersFilms", x => new { x.TheaterId, x.FilmId });
                    table.ForeignKey(
                        name: "FK_TheatersFilms_Films_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TheatersFilms_Theaters_TheaterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenresFilms_FilmId",
                table: "GenresFilms",
                column: "FilmId");

            migrationBuilder.CreateIndex(
                name: "IX_TheatersFilms_FilmId",
                table: "TheatersFilms",
                column: "FilmId");
        }
